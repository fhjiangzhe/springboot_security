 ...
 *
 * Created by JiangZhe on 16/7/15.
 */
...
public class GenerateUtil {
    ...
    private final String moduleName = "mac_admin"; // 对应模块名称（根据自己模块做相应调整!!!务必修改^_^）

    private final String bean_path = "/Users/Jianghe/Downloads/demo/src/main/java/com/example/domain";

    private final String mapper_path = "/Users/Jianghe/Downloads/demo/src/main/java/com/example/mapper";

    private final String xml_path = "/Users/Jianghe/Downloads/demo/src/main/resources/mapper";

    private final String bean_package = "com.example.domain";
    ...
    private void buildSQL( BufferedWriter bw, List<String> columns, List<String> types ) throws IOException {
        ...
        bw.newLine();
        bw.write("\t<select id=\"selectByPrimaryKey\" resultType=\""+bean_package+"."
                + beanName + "\" parameterType=\"java.lang." + processType(types.get(0)) + "\">");
        bw.newLine();
        bw.write("\t\t SELECT");
        bw.newLine();
    ...
    public void generate() throws ClassNotFoundException, SQLException, IOException {
        ...
        List<String> tables = Arrays.asList("t_user_role");
